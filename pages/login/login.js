...
function redirectUserByProfile(profile) {
    ...
    switch(profile) {
        case 'ADMIN':
            ...
            window.location.href = 'http://127.0.0.1:5500/administrador/dashboard/dashboard.html';
            break;
        case 'ANALISTA':
            console.log("Redirecting to admin summary");
            window.location.href = 'http://127.0.0.1:5500/administrador/resumo-administrador.html';
            break;
        case 'USUARIO':
            console.log("Redirecting to investor summary");
            window.location.href = 'http://127.0.0.1:5500/investidor/carteira-resumo/resumo.html';
            break;
        default:
